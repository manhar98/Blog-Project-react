...
import { Upload, Link, Check, Sparkles } from 'lucide-react';
...
export default function Create() {
  ...
  const [type, setType] = useState('Blog'); // 'Blog' | 'Image'
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(toggleCreateForm()); // Close card
  };
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            placeholder="e.g. Echoes of Light: Minimalist Shadows"
            className="w-full px-4 py-3 bg-black/40 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all text-sm font-sans"
          />
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <textarea
            ...
            placeholder="Type your markdown or article body here..."
            className="w-full px-4 py-3 bg-black/40 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all text-sm font-sans"
          />
        </div>
